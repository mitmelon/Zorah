...
class DateHelper
{
    ...
    {
        return $this->carbon->copy()->addMinutes($value)->timestamp;
    }

    public function addDays($value)
    {
        $date = $this->carbon->copy()->addDays($value);
        return $date->format('Y-m-d H:i:s');
    }

    public function addYears($value, $format = 'Y-m-d H:i:s')
    {
        $date = $this->carbon->copy()->addYears($value);
        return $date->format($format);
    }

    public function addDaysTimestamp($value)
    {
        return $this->carbon->copy()->addDays($value)->timestamp;
    }
    ...
    public function formatDate($date, $format = 'd-m-Y g:ia')
    {
    ...
    public function getCurrentDateTimeByCountry($countryName) {
        ...
        return array('timezone' => $timezone, 'date' => $datetime->format('Y-m-d H:i:s'));
    }
    ...
    public function formatTimeAgo($dateInput): string
    {
        return $this->carbon->createFromTimeStamp(strtotime($dateInput))->diffForHumans();
    }

    public function addDurationToTimestamp($value, $unit)
    {
        $date = $this->carbon->copy();
